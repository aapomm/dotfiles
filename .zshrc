...
export ZSH=/Users/aaronmanaloto/.oh-my-zsh
...
plugins=(git bundler ruby rails rvm)
...
alias cucup='cucu --format progress'

alias wiki="ruby ~/proj/mechanize/wiki.rb"

alias z_alias='alias | less'

alias ggpush='gp origin HEAD'
